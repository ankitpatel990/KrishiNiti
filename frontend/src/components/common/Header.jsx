    ...
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-sm border-b border-neutral-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          >
            <span className="inline-flex items-center justify-center h-8 w-8 rounded-lg bg-primary-600 text-white font-display font-bold text-sm">
              FH
            </span>
          ...
          <div className="flex items-center gap-2">
            ...
            {onToggleLanguage && (
              <button
                ...
                className="inline-flex items-center gap-1 rounded-lg px-2.5 py-1.5 text-sm font-medium text-neutral-600 hover:bg-neutral-100 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500"
            ...
            <button
              ...
              className="md:hidden inline-flex items-center justify-center rounded-lg p-2 text-neutral-600 hover:bg-neutral-100 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500"
